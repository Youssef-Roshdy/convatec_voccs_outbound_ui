...
// TESTING
export const SERVER_BASE = 'https://vc-server-convetec-1881-dev.twil.iog';
export const LARAVEL_CRM_URL = 'https://convatec-outbound-crm-test-dot-vci-live.uc.r.appspot.com/';
export const CORE_CRM_URL = 'https://convatec-outbound-crm-test-dot-vci-live.uc.r.appspot.com/';